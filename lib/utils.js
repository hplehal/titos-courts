import { divisionForRank, resolveDivisions } from '@/lib/league/seasonConfig'
...
export function getDivisionInfo(rank, totalTeams, leagueType = 'coed', divisions = null) {
  const resolved = resolveDivisions(divisions, totalTeams, leagueType)
