...
function createClient() {
  ...
  // ONE connection per warm instance. The prod role ("prisma_migration")
  // has a small hard cap, and under tournament-day polling many warm
  // instances × 3 connections exceeded it (P2037). Serverless best
  // practice without an external pooler is max 1; short idle timeout
  // releases it quickly between invocation bursts.
